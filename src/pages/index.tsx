        ...
        <div className="flex items-center justify-between md:py-16 py-10 px-14">
          <div className="flex flex-col items-start max-w-sm gap-4">
            ...
            <div className="md:hidden mx-auto my-8">
              <Button size="medium" variant="secondary">Demander un devis</Button>
            </div>
          </div>
          <div className="hidden md:block">
            <Image className="rounded-lg object-cover w-full h-auto shadow-grey" src="/assets/images/image-1.jpg" width={565.04} height={384} alt={""} />
          </div>
        </div>
